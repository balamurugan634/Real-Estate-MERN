...
const Listing = () => {
  ...
  return <main>
    ...
    {copied && <p className="fixed top-[23%] right-[5%] z-10 bg-slate-100 p-2">Link copied !</p>}
    <div className="flex flex-col max-w-4xl mx-auto p-3 my-3 gap-3">
        ...
        <div className="flex items-center gap-4">
            ...
            <p className="bg-red-900 rounded-md w-full max-w-[200px] text-white text-center p-1">{listing.type ==='rent' ? 'For Rent' :'For Sale'}</p>
            {
                listing.offers && 
                <p className="bg-green-900 rounded-md w-full max-w-[200px] text-white text-center p-1">${+listing.regularprice - +listing.discountprice}</p>
