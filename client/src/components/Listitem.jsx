...
const Listitem = ({listing}) => {
  return (
    <div className='shadow-md hover:shadow-lg overflow-hidden rounded-lg transition-shadow w-full sm:w-[330px]'>
      <Link to={`/listing/${listing._id}`}>
      <img src={listing.imageUrl} className='w-full hover:scale-105 transition-scale duration-300 t h-[330px] md:h-[220px] object-contain' alt="sdfs" />
